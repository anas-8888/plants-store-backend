CREATE TABLE plant (
  ...
  pot_EN VARCHAR(255) NOT NULL DEFAULT 'no info',
  pot_AR VARCHAR(255) NOT NULL DEFAULT 'لا يوجد معلومات',
  ...
  size1_EN VARCHAR(255) NOT NULL DEFAULT 'no info',
  size1_AR VARCHAR(255) NOT NULL DEFAULT 'لا يوجد معلومات',
  size2_EN VARCHAR(255) NOT NULL DEFAULT 'no info',
  size2_AR VARCHAR(255) NOT NULL DEFAULT 'لا يوجد معلومات',
  size3_EN VARCHAR(255) NOT NULL DEFAULT 'no info',
  size3_AR VARCHAR(255) NOT NULL DEFAULT 'لا يوجد معلومات',
  size4_EN VARCHAR(255) NOT NULL DEFAULT 'no info',
  size4_AR VARCHAR(255) NOT NULL DEFAULT 'لا يوجد معلومات',
  price1 DECIMAL(10, 2) NOT NULL DEFAULT -1.00,
  price2 DECIMAL(10, 2) NOT NULL DEFAULT -1.00,
  price3 DECIMAL(10, 2) NOT NULL DEFAULT -1.00,
  price4 DECIMAL(10, 2) NOT NULL DEFAULT -1.00,
  subcategory_id INT,
